...
reg   [199:0] ap_phi_mux_p_Val2_s_phi_fu_98_p4;
wire   [199:0] ap_phi_reg_pp0_iter0_p_Val2_s_reg_95;
reg   [199:0] ap_phi_reg_pp0_iter1_p_Val2_s_reg_95;
wire   [199:0] zext_ln476_fu_142_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln476_reg_162 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_032_0_reg_61 <= {{ap_phi_mux_p_Val2_s_phi_fu_98_p4[199:8]}};
    end else if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        p_032_0_reg_61 <= 192'd0;
    end
end
...
assign icmp_ln476_fu_104_p2 = ((t_0_reg_84 == 13'd6200) ? 1'b1 : 1'b0);
