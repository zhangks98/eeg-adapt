...
(* CORE_GENERATION_INFO="Thresholding_Batch_3_Thresholding_Batch_3,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.935000,HLS_SYN_LAT=208,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1852,HLS_SYN_LUT=5836,HLS_VERSION=2019_1}" *)

module Thresholding_Batch_3_Thresholding_Batch_3 (
        ap_clk,
        ap_rst_n,
        in0_V_V_TDATA,
        in0_V_V_TVALID,
...
wire    grp_Thresholding_Batch_fu_286_ap_start;
wire    grp_Thresholding_Batch_fu_286_ap_done;
wire    grp_Thresholding_Batch_fu_286_ap_idle;
wire    grp_Thresholding_Batch_fu_286_ap_ready;
wire    grp_Thresholding_Batch_fu_286_in_V_V_TVALID;
wire    grp_Thresholding_Batch_fu_286_in_V_V_TREADY;
wire   [7:0] grp_Thresholding_Batch_fu_286_out_V_V_TDATA;
wire    grp_Thresholding_Batch_fu_286_out_V_V_TVALID;
wire    grp_Thresholding_Batch_fu_286_out_V_V_TREADY;
reg    grp_Thresholding_Batch_fu_286_ap_start_reg;
...
#0 grp_Thresholding_Batch_fu_286_ap_start_reg = 1'b0;
#0 ap_CS_fsm = 4'd1;
end

Thresholding_Batch_3_Thresholding_Batch grp_Thresholding_Batch_fu_286(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(grp_Thresholding_Batch_fu_286_ap_start),
    .ap_done(grp_Thresholding_Batch_fu_286_ap_done),
    .ap_idle(grp_Thresholding_Batch_fu_286_ap_idle),
    .ap_ready(grp_Thresholding_Batch_fu_286_ap_ready),
    .in_V_V_TDATA(in0_V_V_0_data_out),
    .in_V_V_TVALID(grp_Thresholding_Batch_fu_286_in_V_V_TVALID),
    .in_V_V_TREADY(grp_Thresholding_Batch_fu_286_in_V_V_TREADY),
    .out_V_V_TDATA(grp_Thresholding_Batch_fu_286_out_V_V_TDATA),
    .out_V_V_TVALID(grp_Thresholding_Batch_fu_286_out_V_V_TVALID),
    .out_V_V_TREADY(grp_Thresholding_Batch_fu_286_out_V_V_TREADY)
);
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_Thresholding_Batch_fu_286_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_Thresholding_Batch_fu_286_ap_start_reg <= 1'b1;
        end else if ((grp_Thresholding_Batch_fu_286_ap_ready == 1'b1)) begin
            grp_Thresholding_Batch_fu_286_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((out_V_V_1_load_A == 1'b1)) begin
        out_V_V_1_payload_A <= grp_Thresholding_Batch_fu_286_out_V_V_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((out_V_V_1_load_B == 1'b1)) begin
        out_V_V_1_payload_B <= grp_Thresholding_Batch_fu_286_out_V_V_TDATA;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        in0_V_V_0_ack_out = grp_Thresholding_Batch_fu_286_in_V_V_TREADY;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (grp_Thresholding_Batch_fu_286_ap_done == 1'b1))) begin
...
assign grp_Thresholding_Batch_fu_286_ap_start = grp_Thresholding_Batch_fu_286_ap_start_reg;

assign grp_Thresholding_Batch_fu_286_in_V_V_TVALID = in0_V_V_0_state[1'd0];

assign grp_Thresholding_Batch_fu_286_out_V_V_TREADY = (out_V_V_1_ack_in & ap_CS_fsm_state3);
...
assign out_V_V_1_vld_in = grp_Thresholding_Batch_fu_286_out_V_V_TVALID;
...
endmodule //Thresholding_Batch_3_Thresholding_Batch_3
