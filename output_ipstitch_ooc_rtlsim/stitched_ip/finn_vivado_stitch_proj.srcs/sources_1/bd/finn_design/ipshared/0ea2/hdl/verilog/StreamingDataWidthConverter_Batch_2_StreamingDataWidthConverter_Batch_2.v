...
(* CORE_GENERATION_INFO="StreamingDataWidthConverter_Batch_2_StreamingDataWidthConverter_Batch_2,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.723000,HLS_SYN_LAT=6005,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=7337,HLS_SYN_LUT=364,HLS_VERSION=2019_1}" *)
...
input   out_V_V_TREADY;
 ...
 reg    ap_rst_n_inv;
reg   [1799:0] in0_V_V_0_data_out;
wire    in0_V_V_0_vld_in;
wire    in0_V_V_0_vld_out;
wire    in0_V_V_0_ack_in;
reg    in0_V_V_0_ack_out;
reg   [1799:0] in0_V_V_0_payload_A;
reg   [1799:0] in0_V_V_0_payload_B;
