...
(* CORE_GENERATION_INFO="StreamingFCLayer_Batch_3_StreamingFCLayer_Batch_3,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.740500,HLS_SYN_LAT=205,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1816,HLS_SYN_LUT=1665,HLS_VERSION=2019_1}" *)
...
wire    grp_Matrix_Vector_Activa_fu_28_in_V_V_TVALID;
wire    grp_Matrix_Vector_Activa_fu_28_in_V_V_TREADY;
wire   [23:0] grp_Matrix_Vector_Activa_fu_28_out_V_V_TDATA;
wire    grp_Matrix_Vector_Activa_fu_28_out_V_V_TVALID;
wire    grp_Matrix_Vector_Activa_fu_28_out_V_V_TREADY;
wire    grp_Matrix_Vector_Activa_fu_28_weight_V_V_TVALID;
...
StreamingFCLayer_Batch_3_Matrix_Vector_Activa grp_Matrix_Vector_Activa_fu_28(
    ...
    .in_V_V_TVALID(grp_Matrix_Vector_Activa_fu_28_in_V_V_TVALID),
    ...
    .weight_V_V_TVALID(grp_Matrix_Vector_Activa_fu_28_weight_V_V_TVALID),
...
always @ (posedge ap_clk) begin
    if ((out_V_V_1_load_A == 1'b1)) begin
        out_V_V_1_payload_A <= grp_Matrix_Vector_Activa_fu_28_out_V_V_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((out_V_V_1_load_B == 1'b1)) begin
        out_V_V_1_payload_B <= grp_Matrix_Vector_Activa_fu_28_out_V_V_TDATA;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        in0_V_V_0_ack_out = grp_Matrix_Vector_Activa_fu_28_in_V_V_TREADY;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        weights_V_V_0_ack_out = grp_Matrix_Vector_Activa_fu_28_weight_V_V_TREADY;
    end else begin
...
assign grp_Matrix_Vector_Activa_fu_28_in_V_V_TVALID = in0_V_V_0_state[1'd0];

assign grp_Matrix_Vector_Activa_fu_28_out_V_V_TREADY = (out_V_V_1_ack_in & ap_CS_fsm_state3);

assign grp_Matrix_Vector_Activa_fu_28_weight_V_V_TVALID = weights_V_V_0_state[1'd0];
...
assign out_V_V_1_vld_in = grp_Matrix_Vector_Activa_fu_28_out_V_V_TVALID;
