...
(* CORE_GENERATION_INFO="StreamingDataWidthConverter_Batch_8_StreamingDataWidthConverter_Batch_8,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.723000,HLS_SYN_LAT=1305,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=3271,HLS_SYN_LUT=360,HLS_VERSION=2019_1}" *)

module StreamingDataWidthConverter_Batch_8_StreamingDataWidthConverter_Batch_8 (
        ap_clk,
        ap_rst_n,
        in0_V_V_TDATA,
        in0_V_V_TVALID,
...
StreamingDataWidthConverter_Batch_8_StreamingDataWidthCo_1 grp_StreamingDataWidthCo_1_fu_26(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
endmodule //StreamingDataWidthConverter_Batch_8_StreamingDataWidthConverter_Batch_8
