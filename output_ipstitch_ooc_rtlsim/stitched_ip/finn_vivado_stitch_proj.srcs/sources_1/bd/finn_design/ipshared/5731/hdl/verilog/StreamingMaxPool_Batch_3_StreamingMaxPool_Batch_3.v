...
(* CORE_GENERATION_INFO="StreamingMaxPool_Batch_3_StreamingMaxPool_Batch_3,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.799000,HLS_SYN_LAT=20,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=8023,HLS_SYN_LUT=5811,HLS_VERSION=2019_1}" *)

module StreamingMaxPool_Batch_3_StreamingMaxPool_Batch_3 (
        ap_clk,
        ap_rst_n,
        in0_V_V_TDATA,
        in0_V_V_TVALID,
...
input   out_V_V_TREADY;
 ...
 reg    ap_rst_n_inv;
reg   [1599:0] in0_V_V_0_data_out;
wire    in0_V_V_0_vld_in;
wire    in0_V_V_0_vld_out;
wire    in0_V_V_0_ack_in;
reg    in0_V_V_0_ack_out;
reg   [1599:0] in0_V_V_0_payload_A;
reg   [1599:0] in0_V_V_0_payload_B;
...
reg   [1599:0] out_V_V_1_data_out;
wire    out_V_V_1_vld_in;
wire    out_V_V_1_vld_out;
wire    out_V_V_1_ack_in;
wire    out_V_V_1_ack_out;
reg   [1599:0] out_V_V_1_payload_A;
reg   [1599:0] out_V_V_1_payload_B;
...
wire   [1599:0] grp_StreamingMaxPool_Pre_fu_47_out_V_V_TDATA;
...
StreamingMaxPool_Batch_3_StreamingMaxPool_Pre grp_StreamingMaxPool_Pre_fu_47(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
endmodule //StreamingMaxPool_Batch_3_StreamingMaxPool_Batch_3
