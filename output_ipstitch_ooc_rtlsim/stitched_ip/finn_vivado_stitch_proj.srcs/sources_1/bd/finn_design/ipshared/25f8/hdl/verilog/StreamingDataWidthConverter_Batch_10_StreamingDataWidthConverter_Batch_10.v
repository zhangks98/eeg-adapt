...
(* CORE_GENERATION_INFO="StreamingDataWidthConverter_Batch_10_StreamingDataWidthConverter_Batch_10,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.723000,HLS_SYN_LAT=455,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=28941,HLS_SYN_LUT=362,HLS_VERSION=2019_1}" *)

module StreamingDataWidthConverter_Batch_10_StreamingDataWidthConverter_Batch_10 (
        ap_clk,
        ap_rst_n,
        in0_V_V_TDATA,
        in0_V_V_TVALID,
...
input   out_V_V_TREADY;
 ...
 reg    ap_rst_n_inv;
reg   [7199:0] in0_V_V_0_data_out;
wire    in0_V_V_0_vld_in;
wire    in0_V_V_0_vld_out;
wire    in0_V_V_0_ack_in;
reg    in0_V_V_0_ack_out;
reg   [7199:0] in0_V_V_0_payload_A;
reg   [7199:0] in0_V_V_0_payload_B;
...
StreamingDataWidthConverter_Batch_10_StreamingDataWidthCo_1 grp_StreamingDataWidthCo_1_fu_26(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
endmodule //StreamingDataWidthConverter_Batch_10_StreamingDataWidthConverter_Batch_10
