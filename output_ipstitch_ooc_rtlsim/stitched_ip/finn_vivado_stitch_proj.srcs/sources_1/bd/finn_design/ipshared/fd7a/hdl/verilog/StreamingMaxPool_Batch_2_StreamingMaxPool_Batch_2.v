...
(* CORE_GENERATION_INFO="StreamingMaxPool_Batch_2_StreamingMaxPool_Batch_2,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.177500,HLS_SYN_LAT=114,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=4836,HLS_SYN_LUT=4792,HLS_VERSION=2019_1}" *)
...
reg   [799:0] out_V_V_1_data_out;
wire    out_V_V_1_vld_in;
wire    out_V_V_1_vld_out;
wire    out_V_V_1_ack_in;
wire    out_V_V_1_ack_out;
reg   [799:0] out_V_V_1_payload_A;
reg   [799:0] out_V_V_1_payload_B;
...
wire   [799:0] grp_StreamingMaxPool_Pre_fu_47_out_V_V_TDATA;
