...
module StreamingDataWidthConverter_Batch_10_StreamingDataWidthCo_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [7199:0] ap_phi_mux_p_Val2_s_phi_fu_98_p4;
wire   [7199:0] ap_phi_reg_pp0_iter0_p_Val2_s_reg_95;
reg   [7199:0] ap_phi_reg_pp0_iter1_p_Val2_s_reg_95;
wire   [7199:0] zext_ln476_fu_142_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln476_reg_162 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_032_0_reg_61 <= {{ap_phi_mux_p_Val2_s_phi_fu_98_p4[7199:80]}};
    end else if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        p_032_0_reg_61 <= 7120'd0;
    end
end
...
assign icmp_ln476_fu_104_p2 = ((t_0_reg_84 == 9'd450) ? 1'b1 : 1'b0);

assign icmp_ln479_fu_116_p2 = ((o_0_reg_73 == 32'd0) ? 1'b1 : 1'b0);

assign icmp_ln490_fu_128_p2 = ((o_fu_122_p2 == 32'd90) ? 1'b1 : 1'b0);

assign o_fu_122_p2 = (32'd1 + o_0_reg_73);

assign out_V_V_TDATA = ap_phi_mux_p_Val2_s_phi_fu_98_p4[79:0];
...
endmodule //StreamingDataWidthConverter_Batch_10_StreamingDataWidthCo_1
